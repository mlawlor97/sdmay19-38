...
# server.login("sdmay19@gmail.com", "Forensics4")
# os.environ["GPAPI_GSFID"] = str(server.gsfId)
# os.environ["GPAPI_TOKEN"] = str(server.authSubToken)
# # exit(0)
# gsfId = int(os.environ["GPAPI_GSFID"])
# authSubToken = os.environ["GPAPI_TOKEN"]
# print(str(gsfId) + " : " + authSubToken)
# exit(0)

# # LOGIN
# print("\nLogin with ac2dm token and gsfId saved\n")
server.login(gsfId=3948690411096122542, authSubToken="FwfSBWszDgviSe1ivuuvKa0qjnOTUlcpvGzS9sEtSSdn59NrCqTO9oeyE2h5qiorr-ycCw.")
