...
class App extends Component {
  ...
  downloadAPK() {
    ...
    setTimeout(() => {
      const response = {
        file: 'http://35.194.33.104:3000/api/v1/download/' + captainFalcon
      }
  ...
  grabStats() {
    axios
      .get('http://35.194.33.104:3000/api/v1/stats')
      .then(res => {
        const statView = (
          <div className="stats">
            <ul>
  ...
  handleFiles(files) {
    ...
    reader.onload = e => {
      ...
      axios
        .post('http://35.194.33.104:3000/api/v1/applications/', {
          appData: postBody
        })
        .then(res => {
          const dataArray = []
  ...
  onAppClick(event) {
    ...
    const dataArray = []
    axios
      .get('http://35.194.33.104:3000/api/v1/applications/' + event)
      .then(res => {
  ...
  onSubmit(event) {
    ...
    if (this.state.keywordFilter === 'appName') {
      axios
        .get('http://35.194.33.104:3000/api/v1/applications', {
          params: {
